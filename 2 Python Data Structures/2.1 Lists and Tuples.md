...
list = [1, 2, ["pop", "rock"] ,[3,4],["disco",[1,2]]]
print(List)
```
...
```py
list = [1, 2, 3]
list.append(4)  # Appends a single element (4) to the list
print(list)

# Appending another list
list.append([5, 6])  # The list [5, 6] is added as a single element
print(list)
```
...
list = [1, 2, 3, 4, 5, 6]
print('Before change:', list)
del(list[3]) # Delete the 4th elemnt of th list (index 3)
print('After change:', list)
```
...
list = [1, 2, 3, 4, 5, 2, 6]
print('Before change:', list)
list.remove(2) # Remove the first instance of the number 2
print('After change:', list)
list.remove(7) # Remove the number 7 (which is not in the list)
```
